...
pedido_bp.add_url_rule(
    "/pedidos", "listar_todos_pedidos", login_required(pedido_controller.listar_todos_pedidos), methods=["GET"]
)
pedido_bp.add_url_rule(
...
pedido_bp.add_url_rule(
    ...
    login_required(pedido_controller.atualizar_status_pedido),
    methods=["PUT"],
)
